  ...
  return (
    ...
    >
      ...
      <Box maxW={ `${ CONTENT_MAX_WIDTH }px` } m="0 auto" px={{ base: 4, xl: 8 }}>
        ...
        >
          { [
            { label: 'FLOOR_PRICE', value: '85,000 MRD' },
            { label: 'TOTAL_VOLUME', value: '450,000 MRD' },
